...
typedef bool (*is_insert_exec_rewrite_active_hook_type)(void);
...
extern PGDLLEXPORT is_insert_exec_rewrite_active_hook_type is_insert_exec_rewrite_active_hook;
